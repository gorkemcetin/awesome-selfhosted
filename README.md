...
- [Balsa](https://getbalsa.com) - An open source knowledge management platform that meets even the most demanding privacy and security standards. ([Source Code](https://github.com/balsa-team/balsa)) `AGPL-3.0` `Nodejs`
